...
def recorrer_carpeta(carpeta):
    for archivo in os.listdir(carpeta):
        ...
        if os.path.isfile(ruta_completa):
            ...
            print (malware)
            print (harmless)
            with open('departamento.txt', 'r') as archivo_d:
                departamento = archivo_d.read()
            if malware >= 1:
                resultado = -1   # virus
                carpeta_v = 'virus'
                ...
                resultado = 1   # seguro
                #carpeta_v = 'seguro'
                ruta_carpeta = os.path.join('/var/www/html/subidas', departamento)
            ...
            with open('usuario.txt', 'r') as archivo:
                nombre_usu = archivo.read()

            insertar = "INSERT INTO comprobacionn (nombre, id_archivo, resultado, hash, nombre_usu) VALUES (%s,%s,%s,%s,%s)"
            datos = (nombre, id_archivo, resultado, hash_resultado, nombre_usu)
